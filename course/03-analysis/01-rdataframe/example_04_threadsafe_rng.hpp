#ifndef EXAMPLE_04_THREADSAFE_RNG_HELPERS
#define EXAMPLE_04_THREADSAFE_RNG_HELPERS
...
double
GetNormallyDistributedNumberPerSlotGeneratorForEntry(unsigned int slot,
...
#endif // EXAMPLE_04_THREADSAFE_RNG_HELPERS
